// component V is a deconstructor
import React, { Component } from "react";
import calculatorImg from "./calculator.png";
class Calculator extends Component {
    constructor() { // just remeber this
        super(); // dont have to understand .. always put super();

        this.state = { // this means its an object
            header: "Jaden's Calculator",
            displayNum: "0",
            operator: "",
            tempNum: 0
        }
